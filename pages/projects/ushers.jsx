    ...
    <div className="w-full bg-gradient-to-b from-black to-gray-900 text-white">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          ...
          >
            React / Ant Design / REST APIs / CMS / Bug Fixes / UI Maintenance
          </motion.h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        ...
        >
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            Ushers is a platform that includes both admin and user-side
            applications. I contributed to building a React-based admin panel
            (CMS) using Ant Design. This CMS was designed to streamline data
            management and saving time. I was involved in improving the website
            UI, ensuring maintainability of the codebase, and integrating REST
            APIs for data communication. This project allowed me to work on both
            the administrative and user interfaces of a complex application.
          </p>
          {/* Add a link to the demo if available */}
          <a
            target="_blank"
            href="https://ushersonline.com/"
        ...
        >
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1 gap-4">
              ...
              <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> New
                Features and Pages
              </p>
              <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> UI / Bug
                Fixes
              </p>
            </div>
          </div>
