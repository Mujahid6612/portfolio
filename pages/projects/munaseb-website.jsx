...
import munasebWebsiteImg from "../../public/assets/projects/munaseb-website.png"; // Placeholder image
import { RiRadioButtonFill } from "react-icons/ri";
import Link from "next/link";
import { motion } from "framer-motion";

const MunasebWebsite = () => {
  return (
    <div className="w-full bg-gradient-to-b from-black to-gray-900 text-white">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          ...
          >
            Next.js / TypeScript / i18n / SHadcn UI / Tailwind CSS
          </motion.h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        ...
        >
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            "Munaseb" is a Digital Brokerage Company of Saudi Arabia, that aims
            to build bridges of trust between lenders and borrowers through our
            digital platform. I contributed to the development of the website
            for this platform. The website was built using Next.js and
            TypeScript, incorporating i18n for language translation support
            (Arabic and English) and Shadcn UI for the design. My work involved
            integrating REST APIs and handling complex form validation logic and
            also adding new features and pages based on the provided design.
          </p>
          {/* Add a link to the demo if available */}
          <a
            target="_blank"
            href="https://munaseb.com.sa/"
        ...
        >
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1 gap-4">
              ...
              <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> Tailwind
                CSS
              </p>
            </div>
          </div>
