...
import ludunImg from "../../public/assets/projects/ludun.png"; // Placeholder image
    ...
    <div className="w-full bg-gradient-to-b from-black to-gray-900 text-white">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          ...
          >
            Next.js / TypeScript / MUI / Tailwind CSS / Redux / i18n
          </motion.h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        ...
        >
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            LUDUN is an e-commerce platform for Saudi people. I contributed to fixing UI and functionality bugs. A website with Next.js, TypeScript, MUI, Tailwind CSS, Redux, and i18n for language translation. Wrote maintainable code and components.
          </p>
          ...
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1 gap-4">
              ...
              <p className="flex items-center text-gray-300">
               ...
               <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> MUI
              </p>
               <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> Tailwind CSS
              </p>
               <p className="flex items-center text-gray-300">
