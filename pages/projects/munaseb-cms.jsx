...
import munasebCmsImg from "../../public/assets/projects/munaseb-cms.png"; // Placeholder image
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        ...
        >
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            This is the CMS for munaseb. I contributed to the development of the
            admin panel (CMS) for this platform. The CMS was built using
            React.js and TypeScript, incorporating i18n for language translation
            support (Arabic and English). My work involved integrating REST APIs
            and handling complex form validation logic and also adding new
            features and pages based on the provided design.
          </p>
        ...
        >
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1 gap-4">
              ...
              <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> React.js
              </p>
              <p className="flex items-center text-gray-300">
              ...
              <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> Material
                UI
              </p>
              <p className="flex items-center text-gray-300">Bootstrap</p>
            </div>
          </div>
        </motion.div>
        <Link href="/#projects">
