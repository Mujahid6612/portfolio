...
import fifaGuessImg from "../../public/assets/projects/placeholder.png"; // Placeholder image
    ...
    <div className="w-full bg-gradient-to-b from-black to-gray-900 text-white">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          ...
          >
            React / Responsive Design / REST APIs
          </motion.h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        ...
        >
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            This was a web application for FIFA match predictions. My contributions focused on implementing a responsive design to ensure a seamless user experience across different devices, and developing a countdown timer for matches. I also enhanced the overall UI/UX by fixing issues and collaborated on bug fixes, feature additions, and code reviews to maintain high coding standards. The application integrated REST APIs to fetch necessary data.
          </p>
        ...
        >
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1 gap-4">
              ...
              <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> Responsive Design
              </p>
               <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> Countdown Timer
              </p>
               <p className="flex items-center text-gray-300">
