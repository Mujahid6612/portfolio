...
import blockleteGamesCmsImg from "../../public/assets/projects/blocklete-cms.png"; // Placeholder image
import { RiRadioButtonFill } from "react-icons/ri";
import Link from "next/link";
import { motion } from "framer-motion";

const blockleteGamesCms = () => {
  return (
    <div className="w-full bg-gradient-to-b from-black to-gray-900 text-white">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <Image
          ...
          layout="fill"
          src={blockleteGamesCmsImg}
          alt="Blocklete Games CMS App"
        />
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          ...
          >
            React / JavaScript / Ant Design / CMS
          </motion.h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        ...
        >
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            For Blocklete Games, I built an admin panel (CMS) from scratch using React, JavaScript, and Ant Design. This CMS was developed to facilitate internal team data management, saving significant time compared to their previous process of using Postman. I also addressed and fixed issues with the website UI and focused on writing maintainable code and components for better user experience.
          </p>
        ...
        >
          <div className="p-2">
            ...
            <div className="grid grid-cols-3 md:grid-cols-1 gap-4">
              ...
              <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> JavaScript
              </p>
               <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> Ant Design
              </p>
               <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> CMS
              </p>
               <p className="flex items-center text-gray-300">
                <RiRadioButtonFill className="pr-1 text-[#00df9a]" /> Maintainable Code
              </p>
            </div>
          </div>
        </motion.div>
...
export default blockleteGamesCms; 